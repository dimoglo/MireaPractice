package com.example.mireapractice.ui.notifications
    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                // Контент с текстом о том, что пока нет уведомлений
                Box(
                    modifier = Modifier
                        .fillMaxSize()
                    ...
                    Text(
                        text = "На данный момент у Вас нет уведомлений",
                        fontSize = 18.sp,
                        fontWeight = FontWeight.Medium,
                        color = Color2.copy(0.8f)
                    )
                }
            }
        }
